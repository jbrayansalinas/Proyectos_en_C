/*
Hacer un programa en C. Para guardar los numeros de celular, que muestre un menu 
...
void crear(){
	...
	char direccion[] = "C:\\Users\\Wposs\\Documents\\C\\Proyectos_en_C\\Cya\\prueba051.txt";
	char rpt;
